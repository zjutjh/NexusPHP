...
(
	...
	'text_bonus_points' => "個魔力值，如果你的宣傳鏈結獲得一次來自一個未記錄的IP的點擊。",
	...
	'col_note' => "註釋",
	'row_xhtml' => "XHTML 1.0",
	'text_xhtml_note' => "如果你有個人網站，你可以在頁面中使用XHTML程式碼。",
	'row_html' => "HTML 4.01",
	'text_html_note' => "如果你有個人網站，你可以在頁面中使用HTML程式碼。",
	'row_bbcode' => "BBCode論壇程式碼",
	'text_bbcode_note' => "大部分論壇程式（如vBulletin，Discuz!，PHPWind）支援名為BBCode的論壇程式碼。你可以將此程式碼放在你的簽名檔中。",
